...
class Device:
    ...
    def open(self):
        for udev in self.context.list_devices(parent=self.parent, subsystem="hidraw"):
            ...
            # fmt: off
            desc5 = [5, 1, 9, 6, 161, 1, 5, 7, 25, 224, 41, 231, 21, 0, 37, 1, 117, 0, 149, 0, 129, 2, 129, 1, 25, 0, 41, 101, 21, 0, 37, 101, 117, 0, 149, 0, 129, 0, 5, 8, 25, 1, 41, 5, 21, 0, 37, 1, 117, 0, 149, 0, 145, 2, 149, 0, 145, 1, 192]
            desc4 = [6, 55, 19, 9, 1, 161, 1, 9, 2, 21, 0, 38, 255, 0, 117, 8, 150, 0, 1, 129, 2, 9, 4, 150, 0, 1, 145, 2, 9, 6, 149, 7, 177, 2, 192]
            desc3 = [5, 1, 9, 6, 161, 1, 5, 8, 21, 0, 37, 1, 117, 1, 149, 5, 25, 1, 41, 5, 145, 2, 117, 3, 149, 1, 145, 1, 5, 7, 21, 0, 37, 1, 117, 1, 149, 8, 25, 224, 41, 231, 129, 2, 117, 1, 149, 46, 25, 4, 41, 49, 129, 2, 117, 2, 149, 1, 129, 1, 117, 1, 149, 105, 25, 51, 41, 155, 129, 2, 117, 7, 149, 1, 129, 1, 117, 1, 149, 8, 25, 157, 41, 164, 129, 2, 117, 1, 149, 46, 25, 176, 41, 221, 129, 2, 117, 2, 149, 1, 129, 1, 192]
            ...
            if hidraw.getRawReportDescriptor() == desc4:
